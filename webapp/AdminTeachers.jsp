        ...
        <div class="row">
          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h1 class="h2">Teacher's List Accessing Portal</h1>
            ...
            <div class="table-responsive card">
              <table class="table table-striped table-sm">
                ...
                <%
                AllStudentInfoCarrier Tfetch = new AllStudentInfoCarrier();
                
                AllUserDAOFetch get = new AllUserDAOFetch();
                boolean flag = get.getAllTeachers(Tfetch);
                
                if(flag)
                {
                	Sno = Tfetch.getSno();
                	name = Tfetch.getName();
                	Email = Tfetch.getEmail();
                	Contact = Tfetch.getContact();
                	date = Tfetch.getDate();
                ...
                %>
                  ...
                  <tr>
                    ...
                    <td><%= JDate[i]%></td>
                    <td class="d-flex">
                    	<form action = "TUserDelete" method = "post" id="delete-user" onSubmit="return confirm('Are you sure you wish to delete User');">

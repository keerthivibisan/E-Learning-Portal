...
<body>
	...
	<%StudentVideoRegister check = new StudentVideoRegister();%>
        ...
        <div id="Locked-boxes" class="lesson-boxes card">
            ...
            <div class="box">
                <p onclick="ShowVideo('https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.webm','JavaV2')">Lesson 2</p>
             <%
            ...
            <div class="box">
                <p onclick="ShowVideo('https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.webm','JavaV3')">Lesson 3</p>
               <%
             	//If user saw before video unlocks next

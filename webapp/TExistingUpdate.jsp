            ...
            <div class="col-sm-6 mt-5">
                <div class="card">
                    <div class="card-header text-center">
                        <p class="h5">Existing Module Update</p>
                    </div>

                    <div class="card-body">
                        <form action="ExistingModuleCheck" method="post">

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="Tuid" id="Tuid" placeholder="Your UID" value= <%= TuID%> required>
                                <label for="Tuid">Your UID</label>
                              </div>

                              <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="Cid" name="Cid" placeholder="Course Id" required>
                                <label for="Cid">Module ID</label>
                              </div>
